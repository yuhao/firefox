...
//		if(doc.location.href.substr(0, 6) == "about:")
//			doc.location.href = window.arguments[0];
//		else
//		{
//			if((++i) == 1) saveDocument(window.content.document, true, doc.location.href.replace(/\./g, "-").replace(/http:\/\//g, "").replace(/https:\/\//g, ""));
//		}
//	}
//}
//
...
//  gBrowser.addEventListener("pageshow", instrumentPageLoad, true);
//}, false);
